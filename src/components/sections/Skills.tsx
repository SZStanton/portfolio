...
export function Skills() {
  return (
    <section id="skills" aria-labelledby="skills-heading" className="pt-24">
      <div className="container-page">
        ...
        {/* No reveal on the summary, matching the prose in About. */}
        <p className="measure-text mt-6 text-xl leading-relaxed">
          The MERN stack is where I am most at home, alongside Python and
          SQLite. Anything marked as learning is something I'm currently
          exploring and putting into practice.
        </p>

        {/* Groups cascade in order, but each one's pills arrive together. */}
        <RevealGroup className="mt-10 space-y-7" gap={0.13}>

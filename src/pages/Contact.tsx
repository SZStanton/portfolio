  ...
  return (
    <section className="py-24">
      ...
      <p className="mt-6 max-w-2xl text-lg leading-relaxed">
        Open to junior and graduate developer roles, and happy to hear about anything else. Fill in
        the form and it comes straight to my inbox.
      </p>

      <div className="mt-12 grid gap-12 md:grid-cols-3">
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 md:col-span-2" noValidate>
          <div>
          ...
          <div>
            ...
            <input id="email" type="email" {...register('email')} className={fieldStyles} />
          ...
          <div>
            ...
            <textarea id="message" rows={6} {...register('message')} className={fieldStyles} />
